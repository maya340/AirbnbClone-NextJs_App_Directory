...
const GreatestOutdoors = ({
  ...
  return (
    <div className="container relative">
      <div className="relative h-96 min-w-300px   animate-[fadeInUp_0.6s_ease-in-out]">
        <Image
          src={img}
          alt="GreatestOutdoors-card"
          fill
          className="rounded-2xl -z-10 object-cover"
        />
      </div>
      <div className="absolute top-32 left-12   animate-[fadeInUp_0.6s_ease-in-out]">
